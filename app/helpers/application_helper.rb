module ApplicationHelper
  ...
  def back_link_to(label, url, action, **options)
    link_to url,
      class: "absolute top-1 left-2 sm:left-4 p-2 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center gap-2 cursor-pointer",
