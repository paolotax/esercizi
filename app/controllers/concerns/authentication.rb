module Authentication
  ...
  class_methods do
    ...
    # Allow access with or without account scope (for shared content like books)
    def allow_any_account_scope(**options)
      skip_before_action :require_account, **options
    end
  end
  ...
  private
    ...
    def require_account
      redirect_to session_menu_path(script_name: nil) unless Current.account.present?
    end
