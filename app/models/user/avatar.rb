module User::Avatar
  ...
  private
    ...
    def avatar_dimensions_allowed
      return unless avatar.new_record? # Solo per nuovi upload
      return unless avatar.blob.analyzed? || (avatar.blob.service.exist?(avatar.blob.key) && avatar.blob.analyze)
      ...
      # File non esiste, ignora la validazione
    end
end
