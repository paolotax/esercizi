...
# Metodi per il rendering della griglia quaderno per sottrazioni
# Genera la matrice per il partial unificato _quaderno_grid
module Sottrazione::GridRenderable
  ...
  # Stringa dell'operazione (es. "500 - 123 =")
  def operation_string
    "#{raw_minuend} - #{raw_subtrahend} ="
  end
  ...
  def to_grid_matrix
    ...
    display_title = show_minuend_subtrahend? ? title : (title.presence || operation_string)
  ...
  def show_minuend_subtrahend?
    show_minuend_subtrahend.nil? ? false : show_minuend_subtrahend
  end
  ...
  def show_borrow?
    show_borrow.nil? ? true : show_borrow
  end
